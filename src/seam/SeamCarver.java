...
public class SeamCarver {
	...
	public void removeHorizontalSeam(int[] seam) {
		...
		// TODO: possible improvement would be to recalculate only the energy
	 ...
	 * IMPROVEMENT: transpose only the energy matrix when needed. Instead of
	 * transposing it back again, check if the energy matrix was actually
	 * transposed
	 */
